...
function Options(props) {
    ...
    const Item = (props) => {
        ...
        return <div className="flex hover:bg-gray-200 hover:shadow-md py-3 rounded-md cursor-pointer" onClick={props.onClick}>
    ...
    return <div ref={ref} className="relative w-full h-full z-10">
        ...
        <div className={(!open ? "hidden" : "showy") + " absolute origin-top-right right-0"}>
            <div className="flex flex-col h-full bg-gray-100 rounded-md p-4 shadow-lg border-gray-200 border-2" style={{ width: "60rem" }}>
                ...
                <div className="grid grid-cols-2 gap-4">
                    <Item title="Download" desc="Download a transcript of the current discussion." onClick={() => DownloadTranscript(state)}>
