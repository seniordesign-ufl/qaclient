...
function NewPost(props) {
    ...
    return (
        ...
        >
            ...
            <Modal.Body>
                <Form>
                    <Form.Group controlId="post.title">
                        <Form.Label><b>TITLE</b><span className="required">*</span></Form.Label>
                        <Form.Control type="text" placeholder="Short, descriptive subject" onChange={handleTitleChange} />
                    </Form.Group>
                    <Form.Group controlId="post.body">
                        <Form.Label><b>DETAILS</b></Form.Label>
                        <Form.Control as="textarea" placeholder="Any additional details..." rows={5} onChange={handleBodyChange} />
                    </Form.Group>
            ...
            <Modal.Footer>
                <Button variant="secondary" className="cancel-btn" onClick={props.onHide}>Cancel</Button>
                <Button variant="primary" className="create-post-btn" onClick={handleSubmitForm}>Create Post</Button>
            </Modal.Footer>
        </Modal>
    )
};
